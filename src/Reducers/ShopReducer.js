...
import {
    ...
    GET_QUANTITY, SEARCH_TEXT, GET_SEARCH_PARAMS,GET_SEARCH
} from '../Actions/types';
const INITIAL_STATE = {
    departments: '', loading: true, selectedDepartment: 0,
    categories: '', departmentColor: '', items: [], itemsLoading: true, product: '', cartId: '', cartItems: '',
    user_data: '', attributes: '', colorAtr: '', sizeAtr: '', cartCount: 0, totalAmount: 0, quantity: '', searchText: '',
    allWords: 'off', page: 1, limit: 20, descriptionLength: 200,searcResult:''
};
    ...
    switch (action.type) {
        ...
        case GET_SEARCH_PARAMS:
            return {
                ...
                page: action.page,
                limit: action.limit,
                descriptionLength: action.description
            }
            case GET_SEARCH:
                return{...state,searcResult:action.payload}
        default:
            return state
    }
